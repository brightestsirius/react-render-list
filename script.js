...
var List = function (_React$Component) {
    ...
    function List(props) {
        ...
        if (_this.props.list) {
            ...
            _this.state.nonSelectedItems = _this.state.list.map(function (item, index) {
                return index;
            });
        ...
        value: function render() {
            ...
            if (this.state.list) {
                return React.createElement(
                    'table',
                    { style: { borderWidth: this.state.border } },
                    React.createElement(
                        'tbody',
                        null,
